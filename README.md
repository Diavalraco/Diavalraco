...
[![](https://visitcount.itsvg.in/api?id=diavalraco&icon=6&color=6)](https://visitcount.itsvg.in)
...
```yaml
Role: Full Stack Engineer  |  location: India 🇮🇳  |  motto: "Build fast. Scale smart. Ship often."
...
| Domain | Skills |
|---|---|
| **System Design** | HLD, LLD, CAP Theorem, Distributed Systems, Scalability Patterns |
| **Architecture** | Microservices, Event-Driven, Design Patterns, API Rate Limiting, Caching |
| **Data Engineering** | ETL/ELT Pipelines, Sharding, Indexing, Distributed Tracing |
| **CS Fundamentals** | DSA, OOP, SOLID, SDLC, TDD, Code Review |
| **Agile** | Scrum, Sprint Planning, Unit & Integration Testing |
